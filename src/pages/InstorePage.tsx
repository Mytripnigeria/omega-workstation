...
const InstorePage = () => {
  ...
  // Per-location stock rows for the item being transferred (from/to options).
      ...
      },
      {
        onSuccess: () => {
          ...
          setToast({
            open: true,
            type: "success",
            title: adjustModal.direction === "add" ? "Stock added" : "Stock reduced",
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-6">
        <div className="bg-card border border-border rounded-2xl p-8 text-center max-w-sm">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            Instore inventory is available to managers and supervisors only.
          </p>
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-lg font-bold text-foreground">Instore Inventory</h1>
      ...
      >
        <DialogContent className="rounded-2xl max-w-sm">
          <DialogHeader>
            <DialogTitle>
              {adjustModal.direction === "add" ? "Add stock" : "Reduce stock"}
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <Textarea
                placeholder="e.g. Restock from supplier, spoilage, prep usage"
                value={adjustReason}
        ...
        <DialogContent className="rounded-2xl max-w-sm">
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <Textarea
                placeholder="e.g. Move to kitchen for tonight's service"
